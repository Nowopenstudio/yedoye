...
export default function ReadScroll({data,time}:any) {
  ...
  return (
      ...
      <motion.div  className="flex items-center z-[1] flex-nowrap w-max" ref={ref} style={{x:xTranslation}}>
              ...
              <a  href={data.url} className="flex flex-shrink-0 items-center uppercase pr-[--sm] gap-[--sm] w-max"><h2 className="flex-shrink-0">{data.cta}</h2><Arrow fill={`var(--purple)`} className="flex-shrink-0 w-[120px] h-auto" /></a>
             <a  href={data.url} className="flex flex-shrink-0 items-center uppercase pr-[--sm] gap-[--sm] w-max"><h2 className="flex-shrink-0">{data.cta}</h2><Arrow fill={`var(--purple)`} className="flex-shrink-0 w-[120px] h-auto" /></a>
              <a  href={data.url} className="flex flex-shrink-0 items-center uppercase pr-[--sm] gap-[--sm] w-max"><h2 className="flex-shrink-0">{data.cta}</h2><Arrow fill={`var(--purple)`} className="flex-shrink-0 w-[120px] h-auto" /></a>
              <a  href={data.url} className="flex flex-shrink-0 items-center uppercase pr-[--sm] gap-[--sm] w-max"><h2 className="flex-shrink-0">{data.cta}</h2><Arrow fill={`var(--purple)`} className="flex-shrink-0 w-[120px] h-auto" /></a>
                <a  href={data.url} className="flex flex-shrink-0 items-center uppercase pr-[--sm] gap-[--sm] w-max"><h2 className="flex-shrink-0">{data.cta}</h2><Arrow fill={`var(--purple)`} className="flex-shrink-0 w-[120px] h-auto" /></a>
