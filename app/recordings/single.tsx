...
export default function Single({data,count}:any) {
  ...
  return (
     ...
     <Link href={`/recordings/${data.slug}`} onMouseOver={!mobile?()=>over():undefined} onMouseOut={!mobile?()=>out():undefined} className={`w-[100vw] md:w-[50vw] 2xl:w-[33.33333333333333vw]  md:flex-shrink-0 h-[calc(100dvh-116px)] md:h-full overflow-hidden relative recordingSingle border-none md:border-2 border-[--purple] block md:inline-block `}>
